# 🛸 Mothership Launch Guide

## Twitter/X Thread

### Tweet 1 (Hook)
```
I built an AI agent system that plans, codes, tests, and reviews features automatically.

It's called Mothership. 🛸
...
Single AI = jack of all trades
Mothership = specialized experts

Like having a dev team instead of one generalist.

And it loops until complete. Fresh context each time.
```
...
### Tweet 7 (Credits + CTA)
```
Inspired by @GeoffreyHuntley's Ralph pattern and @ryancarson's implementation.

Mothership takes it further: planning + testing + review built in.

⭐ Star if useful: github.com/chriscarterux/Mothership
...
```
🛸 Just open-sourced Mothership - an AI agent orchestration system.
...
One-line install. Works with any AI tool. MIT licensed.

Check it out: github.com/chriscarterux/Mothership

#AI #DeveloperTools #OpenSource #Automation
```
...
### r/programming
```
Title: I built an AI agent system that plans, codes, tests, and reviews automatically
...
### r/artificial
```
Title: Mothership: Specialized AI agents for software development

Instead of one AI doing everything, Mothership uses specialized agents for each phase:

Planning → Building → Testing → Reviewing

Each agent has one job and does it well. The system loops until the feature is complete.

Inspired by Geoffrey Huntley's "Ralph" pattern, but with dedicated testing and review agents built in.

Open source, works with any LLM. Curious what the community thinks.
```
...
```
Title: Show HN: Mothership – AI agents that plan, build, test, and review your features
...
Inspired by Geoffrey Huntley's Ralph pattern. MIT licensed.

GitHub: [link]
Interactive demo: [link]

Would love feedback on the approach and any pain points you'd want solved.
```
